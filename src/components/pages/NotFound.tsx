...
const getRandomDog = () => dogs[Math.floor(Math.random() * dogs.length)];
const getRandomQuip = () => quips[Math.floor(Math.random() * quips.length)];

const NotFound = () => {
  const [dog, setDog] = useState(getRandomDog);
